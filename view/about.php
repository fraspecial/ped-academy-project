...
<div class="container">
        ...
        <div class="row">
            <div class="col-4">
                ...
                <form id='picform' action="" method="post">
                    <a href="core/delete-repository.php?propic=<?= $_SESSION['loggedUser'] ?>">
                ...
                foreach ($user->getLanguageList()->getLanguages() as $language) { ?>
                    <tr>
                        <td data-lang=<?= $language->getName() ?> scope="row">
                            ...
                            <a href="core/delete-repository.php?lang=<?= $language->getName() ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
                                    <polyline points="3 6 5 6 21 6" />
                                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
                                </svg>
    ...
    <section class="mb-5">
        ...
        <div class='row'>
            <h3>Portfolio</h3>
            <a href="core/delete-repository.php?portfolio=<?= $_SESSION['loggedUser'] ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
                    <polyline points="3 6 5 6 21 6" />
                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
                </svg>
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <div class="carousel-row row">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <a href="core/delete-repository.php?pic=<?= $picture->getPath() ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
                                                    <polyline points="3 6 5 6 21 6" />
                                                    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
                                                </svg>
